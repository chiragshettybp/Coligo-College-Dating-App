...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: `https://try-coligo.lovable.app/api/public/social-share?v=${new Date().getTime()}` },
      { name: "twitter:image", content: `https://try-coligo.lovable.app/api/public/social-share?v=${new Date().getTime()}` },
    ],
    links: [
      {
        rel: "stylesheet",
